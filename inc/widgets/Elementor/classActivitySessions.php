 ...
 * @since 1.1.0
 */
class ElementorfielddayActivitySessions extends Widget_Base
{
    /* settings variable */
    ...
    {
        return 'elementor-activity-sessions';
    }

    public function get_title()
    {
        return __('Fieldday Sessions', 'fieldday');
    }
    ...
    private function getSessionsList($sessions, $key = false)
    {
        ...
        if($activitys){
            ...
            //{   
                foreach ($sessions->data->sessions as $singleactivitys => $singleactivity)
                {   
    ...
    { 
        ...
        print "<div style='flex-wrap:wrap;' class='km_featured_activities km_row {$styleClass}'>";
