...
<div class="km_register_wrap km_my_acnt_km_register_wrap">
    ...
    <div class="km_row" id="accountInfo">
        ...
        <?php if ($show_side_bar) {?>
                <div class="km_col_2 km_profile_sidebar">
                    <a href="#" id="kid_generalInfo" data-id="<?php echo $kidData->_id; ?>" class="km_general_info km_nav_link km_active km_primary_color" onclick="return fieldday.profileForm(this, event);">
                        <img src="<?php echo fieldday_URL; ?>/assets/img/personal_info.png">
                        <?php _e('General Info', 'fieldday');?>
                    </a>
                    <a href="#" id="kid_doctors" data-id="<?php echo $kidData->_id; ?>" class="km_Doctors km_nav_link" onclick="return fieldday.profileForm(this, event);">
                        <img src="<?php echo fieldday_URL; ?>/assets/img/doctor.png">
                        <?php _e('Doctors', 'fieldday');?>
                    </a>
                    <a href="#" id="kid_medical" data-id="<?php echo $kidData->_id; ?>" class="km_medical km_nav_link" onclick="return fieldday.profileForm(this, event);">
                        <img src="<?php echo fieldday_URL; ?>/assets/img/medical.png">
                        <?php _e('Medical', 'fieldday');?>
                    </a>
                    <a href="#" id="kid_allergies" data-id="<?php echo $kidData->_id; ?>" class="km_allergies km_nav_link" onclick="return fieldday.profileForm(this, event);">
                        <img src="<?php echo fieldday_URL; ?>/assets/img/allergies.png">
                        <?php _e('Allergies', 'fieldday');?>
                    </a>
                </div>
        <?php }?>
        <div class="km_col_2 km_profile_sidebar">
            ...
            <div class="km_col_10 km_tab_data km_profile_content">
                <?php echo $this->getView('account/kid_generalInfo', ['profile' => $kidData]); ?>
            </div>
        </div>
    </div>
</div>