...
?>
<?php if (isset($buttonOnlySingleSession) && $buttonOnlySingleSession != '') {?>
...
<div class="km_row km_package_wrapper km_activity_sessions km_cls_actvty_session_copy">
<div class="km_col_5">
...
if ($is_single_session) {
    echo '<div class="km_rokuimg km_single_image_wthout_slide_wrap" style="width: 100%;">';
} else {
    echo '<div class="km_rokuimg" style="width: 100%;">';
}
    ...
    ?>
                    ...
                    <?php
if ($is_single_session) {
        $this->displaySessionThumb($session, false);
    } else {
        $this->displaySessionThumb($session, true);
    }
    ...
    ?>
        <?php if ($description != '' && $description != 'Na') {?>
            <div class="km_session_about km_field_wrap km_atc_paymentoptions">
                <h3 class="km_heading_wrap km_primary_color"><?php echo $title; ?></h3>
