<div class="km_thankyou_page">
    ...
    <h2 class="km_thankyou_title"><?php $this->displayText('km_merchandise_thankyou_title');?></h2>
    <div class="km_thankyou_message"><?php $this->displayText('km_merchandise_thankyou_message');?></div>
    <a href="<?php $this->displayText('km_merchandise_checkout_return_url');?>"  class="km_btn km_primary_bg"><?php $this->displayText('km_merchandise_checkout_return_text');?></a>
</div>