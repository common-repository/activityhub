<div class="km_thankyou_page">
    ...
    <h2 class="km_thankyou_title"><?php $this->displayText('km_thankyou_title'); ?></h2>
    <?php if($type=='multiweek') { ?>
        <div class="km_thankyou_message"><?php $this->displayText('km_multiweek_thankyou_message'); ?></div>
    <?php } else { ?>
        <div class="km_thankyou_message"><?php $this->displayText('km_thankyou_message'); ?></div>
    <?php } ?>
