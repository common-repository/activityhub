<div class="km_thankyou_page">
    ...
    <h2 class="km_thankyou_title"><?php $this->displayText('km_waitlist_thankyou_title'); ?></h2>
    <div class="km_thankyou_message"><?php $this->displayText('km_waitlist_thankyou_message'); ?></div>
</div>